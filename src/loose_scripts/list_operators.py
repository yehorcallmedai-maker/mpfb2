# This script searches through the source tree to locate all files which contain an operator
#
...
child = subprocess.run(["/usr/bin/grep", "-Ir", "MPFB_OT_", "src"],stdout=subprocess.PIPE) 
